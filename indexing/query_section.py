"""
This script performs an experiment querying section fields and retrieving
their section names and articles. It assumes that every question in the pickle
